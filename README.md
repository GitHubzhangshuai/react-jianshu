参考视频 https://coding.imooc.com/class/229.html
...
- 通过create-react-app脚手架搭建
- 数据交互:axios
- 数据模拟:create-react-app自带的服务器public目录下放上json文件
- 样式模块化:styled-components
- 状态管理:redux + react-redux + redux-thunk + redux-immutable + immutable
- 路由跳转:react-router-dom
- 组件懒加载(代码分割):react-loadable
- 过渡效果:react-transition-group
